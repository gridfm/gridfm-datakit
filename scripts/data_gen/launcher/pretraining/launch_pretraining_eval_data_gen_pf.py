...
grid_settings = [
    ...
    ("case118_ieee",    40, 1000, 100, 10, 64, 0.9954975, True),
...
output_dir = "/u/apu/gridfm-datakit/scripts/config/evaluation_pretraining_k_10/pf"
...
for grid_name, num_proc, chunk_size, max_iter, k, ram, conv_rate, pf_fast in grid_settings:
    ...
    config['settings']['data_dir'] = "/dccstor/gridfm/powermodels_data/v4/evaluation_pretraining_k_10/pf"
