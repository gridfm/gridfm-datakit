...
output_dir = "/u/apu/gridfm-datakit/scripts/config/case300_contingency_test/pf"
...
for grid_name, num_proc, chunk_size, max_iter, k, ram, conv_rate, pf_fast in grid_settings:
    ...
    config['settings']['data_dir'] = "/dccstor/gridfm/powermodels_data/v4/case300_contingency_test/pf"
    ...
    config["topology_perturbation"]["n_topology_variants"] = ceil(1 / conv_rate) + 1
